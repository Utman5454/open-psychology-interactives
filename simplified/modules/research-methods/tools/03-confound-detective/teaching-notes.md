# Teaching notes - Confound Detective (Simplified)
...
**What students do.**
1. Sort four variables in the revision-app study into their
   categories.
2. Apply repairs one at a time and watch the estimate move from 17.0
   toward the true effect of 3.0.
3. Try the larger sample instead, and compare what it changes.

**What to look for.** The three design repairs move the estimate
itself, 17.0 to 8.5 to 4.5 to 3.0. The larger sample only narrows the
interval around 17.0, from about plus or minus 5 to about plus or
minus 2.

**Debrief.** Which of the four fixes moved the estimate, and which
