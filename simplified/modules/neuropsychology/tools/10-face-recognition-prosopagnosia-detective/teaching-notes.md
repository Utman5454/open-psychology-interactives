# Teaching notes - Face Recognition Detective (Simplified)

`simplified/modules/neuropsychology/tools/10-face-recognition-prosopagnosia-detective/`

**What it teaches.** Recognising a face breaks into ordered steps,
perceiving the face, feeling familiarity, retrieving identity
knowledge, retrieving the name, with reading someone's expression
...
1. Pick which step is impaired, or none, and read which of five
   questions can and cannot be answered.
2. Press "Show me the one people mean by prosopagnosia" to see the
   familiarity break specifically.
3. Once at least two changes have been tried, reveal what the pattern
   shows.

**What to look for.** Breaking familiarity leaves reading someone's
