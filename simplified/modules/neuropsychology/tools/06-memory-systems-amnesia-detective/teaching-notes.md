# Teaching notes - Memory Systems Detective (Simplified)
...
**What students do.**
1. Read three profiles: one loses new facts and keeps the new skill,
   one keeps facts and loses the skill, one loses both.
2. For two claims, whether one system handles both abilities, and
   whether improving at a skill requires remembering having practised
   it, judge each profile as supporting, counting against, or unable
   to decide each claim.
