...
(function () {
  ...
  var CHALLENGE_STUDIES = [
    ...
    },
    {
      ...
      answer: "neither",
      why: "All three conditions are within 4 ms of each other. Invalid is " +
        "still numerically slower than valid. A study reporting only that " +
        "comparison could describe a 4 ms 'cueing effect', which is why " +
        "the neutral baseline matters."
    }
  ];
