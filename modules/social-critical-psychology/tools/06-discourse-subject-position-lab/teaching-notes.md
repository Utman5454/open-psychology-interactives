...
**What it teaches.** Five genres of write-up of the identical
...
**What students do.**
1. Predict what will differ most between five accounts of the same
   six months.
2. Choose one account and check what kind of person it produces, what
   step follows, who it entitles to say what is really happening, and
   where responsibility lands, against four options built from the
   other four genres.
...
of a different genre. These are also authored readings of an invented
