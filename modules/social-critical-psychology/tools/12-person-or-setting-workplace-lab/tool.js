/* =========================================================================
   ...
   EXPERIMENT 1  Two rounds of evidence.
     ...
     Round 2 adds everything else at once - the team's norms and supervision,
     the rota, the queue, the target, and a matched comparison team thirty-six
     points lower. The learner commits to an explanation after each round, and
     the tool keeps the trail, because the point is that nothing about Team B
     changed between the rounds, only what the learner had been shown.
   ...
   EXPERIMENT 2  Ten units, twenty units' worth of interventions.
     ...
     exhaustion score, and then prints the thing that
   ...
   ------------------------------------------------------------------
   Team mean exhaustion starts at 74 on a 0-100 scale. Each intervention
   subtracts points:
   ...
   Budget 10, so nothing buys everything. There are no combination bonuses:
   the panel is not a puzzle with a best package, and what a choice leaves in
   force is the output that matters.
...
(function () {
  ...
  var EVIDENCE = [
    ...
    {
      id: 10, round: 1, level: "structural",
      text:
    ...
    {
      id: 11, round: 1, level: "structural",
      text:
  ...
  /* Two rounds, not three. Round 1 is the individual-level file; round 2 is
     everything else at once - the team, the work, and the team across the
     corridor. Splitting the setting into a relational round and a structural
     round made the learner commit three times to reach a reversal that the
     matched comparison in item 11 settles on its own, and the finer question
     of whether the norms cause the exhaustion or carry it is an argument to
     have after the reversal, not a third judgement before it. It is in the
     debrief. */
  var ROUND_TITLES = [
    "Round 1 - what the review found first",
    "Round 2 - the team, the work, and the team across the corridor"
  ];
    ...
    },
    {
      individual: {
        ...
        body:
          ...
          "file does not support. Item 7 is awkward for it too: if escalating " +
          "is read as not coping, \"not cut out for it\" in an exit interview " +
          "may be somebody repeating what their team taught them."
      },
      relational: {
        tone: "caution",
        ...
        body:
          ...
          "and a norm against escalating are three genuine mechanisms. But a " +
          "rota of split shifts, a queue of bereavement calls with no recovery " +
          "time and a calls-per-hour target are exactly the conditions under " +
          "which a team stops asking for help. These norms may be carrying the " +
          "effect rather than causing it."
      },
      structural: {
        tone: "good",
  ...
  var INTERVENTIONS = [
    ...
    },
    {
      ...
      leaves:
        ...
        "the supervisor. A supervisor who listens and a team that will not " +
        "speak are one problem half-addressed."
    },
    {
    ...
    },
    {
      ...
      leaves:
        ...
        "easier because the target changed. The rota and the target are one " +
        "problem seen from two sides."
    }
  ];

  /* There were pair synergies here - a bonus for taking C with D, and E with
     F. They turned the panel into a puzzle with a right answer, which is not
     what this experiment is for: the question is what your account of the
     problem makes you buy, and what that leaves in force. The substance of
     both pairings is now in the "leaves in force" text, where it is read
     rather than scored. */
  ...
  $('[data-action="worked"]').addEventListener("click", function () {
    ...
    renderExp2({
      announce: "Worked example: both ten-unit extremes modelled. Everything " +
        "individual and relational reaches 53; the two structural changes " +
        "alone reach 40. Read the second row's list of what it leaves running."
    });
  });
