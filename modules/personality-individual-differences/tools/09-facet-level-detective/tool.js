...
(function () {
  ...
  function buildVerdict(theCase) {
    ...
    // "equal by construction" claim this paragraph makes. If the case data
    // is ever edited so the two scores stop matching, this must stop
    // claiming they are equal rather than just hiding the number behind a
    // dash while keeping the false claim in the surrounding prose.
