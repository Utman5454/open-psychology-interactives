        ...
        options: [
          {
            ...
            note:
              "A very common first reading, and it converts a situation " +
                "into a disposition. It may be right. The extract does " +
                "not say it. You supplied it."
          },
          {
...

    {
      ...
      bank: [
        ...
        },
        {
          ...
          level: "latent",
          note:
            "It is a code somebody would write, and it carries a " +
              "judgement into the data under the appearance of a " +
              "description. It makes the second attempt disappear."
        }
      ],
      passes: [
        {
        ...
        options: [
          ...
          },
          {
            ...
            note:
              ...
              "It does not keep you neutral — 'trick' already " +
      ...
      reflexive: {
        ...
        options: [
          ...
          },
          {
            ...
            note:
              "Understandable - it is the quotable line. This selects " +
                "for what will look good in the write-up."
          },
          {
